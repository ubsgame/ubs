...
UBS合约玩法规则：
    ...
    3.静态收益
      ...
      2) 静态收益每天按照合约总资金账户的1%释放，直到静态收益3倍于投资额，自动触发合约停止。
    ...
    5.保障机制
      1) 当资金账户低于保障基金5%时，系统自动触发保障基金“大奖倒计时”机制。
      2) 倒计时长为72小时，期间收到任何参与资金即自动关闭计时器，系统继续正常运作。
      3) 如再次出现无法良性循环时，系统再次启动计时器…如此良性循环。
      4) 若72小时内再未收到参与资金，则“保障基金+资金池 余额”按照最后参与进场的10笔参与数量按比例分配。
    
    6、玩家资金92%进入资金池，6%为技术服务，2%进入保障基金。
    
    7、每个账户可查看直推业绩，以及下方20层业绩。
    
    8、系统开源，数据上链，代码写定，去中心化记账，没有后门，不可篡改，自动运行，自动分发。
